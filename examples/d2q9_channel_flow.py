...
def main():
    ...
    viscosity = 0.1         # Viscosity (nu)
    num_steps = 1000        # Number of simulation steps

    # Initialize solver0
    lbm = D2Q9_GPU_Solver(grid_shape=grid_shape, viscosity=viscosity)
    ...
    lbm.initialize(density=initial_density, velocity=initial_velocity, flags=None)
